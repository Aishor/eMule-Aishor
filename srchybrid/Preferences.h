...
enum EViewSharedFilesAccess { vsfaEverybody, vsfaFriends, vsfaNobody };

enum ENotifierSoundType { ntfstNoSound, ntfstSoundFile, ntfstSpeech };

enum TLSmode : byte { MODE_NONE, MODE_SSL_TLS, MODE_STARTTLS };
...
enum EDefaultDirectory {
  ...
  EMULE_INCOMINGDIR = 2,
  EMULE_LOGDIR = 3,
  EMULE_ADDLANGDIR = 4,  // directories with languages installed by the eMule
                         // (parent: EMULE_EXPANSIONDIR)
  EMULE_INSTLANGDIR = 5, // directories with languages installed by the user or
                         // installer (parent: EMULE_EXECUTABLEDIR)
  ...
  EMULE_TOOLBARDIR = 11,
  EMULE_EXPANSIONDIR = 12 // this is a base directory accessible to all users
                          // for things eMule installs
};

enum EToolbarLabelType : uint8;
enum ELogFileFormat : uint8;

// DO NOT EDIT VALUES like changing uint16 to uint32, or insert any value. ONLY
// append new vars
#pragma pack(push, 1)
...
class CPreferences {
  ...
  static void MovePreferences(EDefaultDirectory eSrc, LPCTSTR const sFile,
                              const CString &dst);
...
public:
  ...
  static UINT
      statsConnectionsGraphRatio; // This will store the divisor, i.e. for 1:3
                                  // it will be 3, for 1:20 it will be 20.
  ...
  static bool m_bDebugSourceExchange; // Sony April 23. 2003, button to keep
                                      // source exchange msg out of verbose log
  ...
  static LPCTSTR GetTempDir(INT_PTR id = 0) {
    return (LPCTSTR)tempdir[(id < tempdir.GetCount()) ? id : 0];
  }
  ...
  static CString GetMuleDirectory(EDefaultDirectory eDirectory,
                                  bool bCreate = true);
  static void SetMuleDirectory(EDefaultDirectory eDirectory,
  ...
  static bool GetUseUserSortedServerList() {
    return m_bUseUserSortedServerList;
  }
...
#define GetBindAddr GetBindAddrA
  ...
  static void Add2SessionTransferData(UINT uClientID, UINT uClientPort,
                                      BOOL bFromPF, BOOL bUpDown, uint32 bytes,
                                      bool sentToFriend = false);
  ...
  static uint64 GetDownOverheadServerPackets() {
    return cumDownOverheadServerPackets;
  }
  ...
  static uint64 GetUpOverheadServerPackets() {
    return cumUpOverheadServerPackets;
  }
  ...
  static uint32 GetUpAvgTime() {
    return cumUpSuccessfulSessions ? cumConnUploadTime / cumUpSuccessfulSessions
                                   : 0;
  }
  ...
  static uint32 GetDownC_AvgTime() {
    return cumDownSuccessfulSessions
               ? cumConnDownloadTime / cumDownSuccessfulSessions
               : 0;
  }
  ...
  static uint32 GetDownS_AvgTime() {
    return sesDownSuccessfulSessions
               ? sesDownAvgTime / sesDownSuccessfulSessions
               : 0;
  }
  ...
  static uint64 GetUpTotalClientData() {
    return GetCumUpData_EDONKEY() + GetCumUpData_EDONKEYHYBRID() +
           GetCumUpData_EMULE() + GetCumUpData_MLDONKEY() +
           GetCumUpData_AMULE() + GetCumUpData_EMULECOMPAT() +
  ...
  static uint64 GetUpSessionClientData() {
    return sesUpData_EDONKEY + sesUpData_EDONKEYHYBRID + sesUpData_EMULE +
           sesUpData_MLDONKEY + sesUpData_AMULE + sesUpData_EMULECOMPAT +
           sesUpData_SHAREAZA;
  }
  ...
  static uint64 GetUpTotalPortData() {
    return GetCumUpDataPort_4662() + GetCumUpDataPort_OTHER();
  }
  ...
  static uint64 GetUpSessionPortData() {
    return sesUpDataPort_4662 + sesUpDataPort_OTHER;
  }
  ...
  static uint64 GetDownTotalClientData() {
    return GetCumDownData_EDONKEY() + GetCumDownData_EDONKEYHYBRID() +
           GetCumDownData_EMULE() + GetCumDownData_MLDONKEY() +
           GetCumDownData_AMULE() + GetCumDownData_EMULECOMPAT() +
           GetCumDownData_SHAREAZA() + GetCumDownData_URL();
  }
  ...
  static uint64 GetDownSessionClientData() {
    return sesDownData_EDONKEY + sesDownData_EDONKEYHYBRID + sesDownData_EMULE +
           sesDownData_MLDONKEY + sesDownData_AMULE + sesDownData_EMULECOMPAT +
           sesDownData_SHAREAZA + sesDownData_URL;
  }
  ...
  static uint64 GetDownTotalPortData() {
    return GetCumDownDataPort_4662() + GetCumDownDataPort_OTHER();
  }
  ...
  static uint64 GetDownSessionDataPort() {
    return sesDownDataPort_4662 + sesDownDataPort_OTHER;
  }
  ...
  // Saved records for servers / network
  static uint32 GetSrvrsMostWorkingServers() {
    return cumSrvrsMostWorkingServers;
  }
  ...
  static void SetExpandedTreeItems(const CString &in) {
  ...
  static DWORD GetServerKeepAliveTimeout() {
    return m_dwServerKeepAliveTimeout;
  }
  ...
  static void SetSplitterbarPositionServer(UINT pos) {
    splitterbarPositionSvr = pos;
  }
  ...
  static void SetSplitterbarPositionIRC(UINT pos) {
    splitterbarPositionIRC = pos;
  }
  ...
  static const CString &GetNotifierConfiguration() {
    return notifierConfiguration;
  }
  static void SetNotifierConfiguration(LPCTSTR pszConfigPath) {
    notifierConfiguration = pszConfigPath;
  }
  static bool GetNotifierOnDownloadFinished() {
    return notifierOnDownloadFinished;
  }
  ...
  static bool GetIRCGetChannelsOnConnect() {
    return m_bIRCGetChannelsOnConnect;
  }
  ...
  static bool GetIRCIgnorePingPongMessages() {
    return m_bIRCIgnorePingPongMessages;
  }
  static bool GetIRCIgnoreEmuleAddFriendMsgs() {
    return m_bIRCIgnoreEmuleAddFriendMsgs;
  }
  static bool GetIRCIgnoreEmuleSendLinkMsgs() {
    return m_bIRCIgnoreEmuleSendLinkMsgs;
  }
  ...
  static bool GetIRCAcceptLinksFriendsOnly() {
    return m_bIRCAcceptLinksFriendsOnly;
  }
  ...
  static void SetSmartIdCheck(bool in_smartidcheck) {
    m_bSmartServerIdCheck = in_smartidcheck;
  }
  ...
  static bool GetManualAddedServersHighPriority() {
    return m_bManualAddedServersHighPriority;
  }
  ...
  static void SetTransferFullChunks(bool m_bintransferfullchunks) {
    m_btransferfullchunks = m_bintransferfullchunks;
  }
  ...
  static void SetCreditSystem(bool m_bInCreditSystem) {
    m_bCreditSystem = m_bInCreditSystem;
  }
  ...
  static LPLOGFONT GetListLogFont() { return &m_lfListText; }
  static void SetListFont(LPLOGFONT plf) { m_lfListText = *plf; }
  ...
  static void SetSafeServerConnectEnabled(bool in) {
    m_bSafeServerConnect = in;
  }
  ...
  static bool IsWin7TaskbarGoodiesEnabled() {
    return m_bShowWin7TaskbarGoodies;
  }
  static void SetWin7TaskbarGoodiesEnabled(bool flag) {
    m_bShowWin7TaskbarGoodies = flag;
  }
  ...
  static void SetWindowLayout(const WINDOWPLACEMENT &in) {
    EmuleWindowPlacement = in;
  }

  static bool GetAutoConnectToStaticServersOnly() {
    return m_bAutoConnectToStaticServersOnly;
  }
  ...
  static INT_PTR AddCat(Category_Struct *cat) {
    catArr.Add(cat);
    return catArr.GetCount() - 1;
  }
  ...
  static Category_Struct *GetCategory(INT_PTR index) {
    return (index >= 0 && index < catArr.GetCount()) ? catArr[index] : NULL;
  }
  static const CString &GetCatPath(INT_PTR index) {
    return catArr[index]->strIncomingPath;
  }
  ...
  static const CUIntArray &GetAllowedRemoteAccessIPs() {
    return m_aAllowedRemoteAccessIPs;
  }
  static uint32 GetMaxWebUploadFileSizeMB() {
    return m_iWebFileUploadSizeLimitMB;
  }
  ...
  static void SetWebCertPath(const CString &path) {
    m_sWebHttpsCertificate = path;
  };
  ...
  static bool IsSecureIdentEnabled() {
    return m_bUseSecureIdent;
  } // use client credits->CryptoAvailable() to check if encryption is really
    // available and not this function
  static bool IsAdvSpamfilterEnabled() { return m_bAdvancedSpamfilter; }
  static bool IsChatCaptchaEnabled() {
    return IsAdvSpamfilterEnabled() && m_bUseChatCaptchas;
  }
  ...
  static bool IsDynUpUseMillisecondPingTolerance() {
    return m_bDynUpUseMillisecondPingTolerance;
  } // EastShare - Added by TAHO, USS limit
  static int GetDynUpPingToleranceMilliseconds() {
    return m_iDynUpPingToleranceMilliseconds;
  } // EastShare - Added by TAHO, USS limit
  ...
  static CString GetHomepageBaseURL() {
    return GetHomepageBaseURLForLevel(GetWebMirrorAlertLevel());
  }
  static CString GetVersionCheckBaseURL();
  static CString GetVersionCheckURL();
  static void SetWebMirrorAlertLevel(uint8 newValue) {
    m_nWebMirrorAlertLevel = newValue;
  }
  ...
  static int GetDebugServerSearchesLevel() {
    return m_iDebugServerSearchesLevel;
  }
  ...
  static void SetEmailSettings(const EmailSettings &settings) {
    m_email = settings;
  }
  ...
  static bool IsCryptLayerPreferred() {
    return IsCryptLayerEnabled() && m_bCryptLayerRequested;
  }
  static bool IsCryptLayerRequired() {
    return IsCryptLayerPreferred() && m_bCryptLayerRequired;
  }
  static bool IsCryptLayerRequiredStrict() {
    return false;
  ...
  // Spam filter
  static bool IsSearchSpamFilterEnabled() {
    return m_bEnableSearchResultFilter;
  }
...
protected:
  ...
  static CString GetDefaultDirectory(EDefaultDirectory eDirectory,
                                     bool bCreate = true);
};
